...
const GlobalStyles = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_emotion_react__WEBPACK_IMPORTED_MODULE_2__.Global, {
  styles: (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.css)`
      body {
...
const Header = ({
  ...
  const headerStyle = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.css)`
    margin: 0 auto;
  ...
  `;
  const linkStyle = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.css)`
    font-size: var(--font-sm);
    text-decoration: none;
  `;
  const logoStyle = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_2__.css)`
    margin: 0;
  `;
...
const Layout = ({
  ...
  // Emotion으로 스타일 정의
  const containerStyle = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.css)`
    margin: 0 auto;
    max-width: var(--size-content);
    padding: var(--size-gutter);
  `;
  const footerStyle = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_4__.css)`
...
/* harmony import */ var _components_GlobalStyles_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/GlobalStyles.js */ "./src/components/GlobalStyles.js");
// src/pages/index.js
...
const IndexPage = () => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_GlobalStyles_js__WEBPACK_IMPORTED_MODULE_3__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_2__.Helmet, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("title", null, "Home | My Gatsby Blog"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("meta", {
    name: "description",
    content: "This is the homepage of my Gatsby blog."
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Welcome to my Gatsby Blog"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "This is my first blog post.")));
};
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"data":{"site":{"siteMetadata":{"title":"Gatsby Default Starter"}}}}');
